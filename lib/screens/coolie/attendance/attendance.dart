        ...
        body: Obx(() {
          ...
          return RefreshIndicator(
            ...
            child: CustomScrollView(
              slivers: [
                SliverToBoxAdapter(child: _FilterRow(ctrl: ctrl)),
                SliverToBoxAdapter(child: _Summary(ctrl: ctrl)),
                ...
                if (ctrl.records.isEmpty)
                  ...
                  SliverList(
                    delegate: SliverChildBuilderDelegate((_, i) {
                      ...
                      return _Card(record: ctrl.records[i], ctrl: ctrl);
...
class _Summary extends StatelessWidget {
  ...
  const _Summary({required this.ctrl});
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _Stat(value: '${s.totalCheckIns}', label: 'Check-ins', icon: Icons.login_rounded, color: _kBlue),
                _divider(),
                _Stat(value: '${s.totalAssignedCollies}', label: 'Assigned', icon: Icons.people_outline_rounded, color: Constants.instance.primary),
                _divider(),
                _Stat(value: '${s.totalOnlineHours.toStringAsFixed(1)}h', label: 'Online hrs', icon: Icons.access_time_rounded, color: _kAmber),
                _divider(),
                _Stat(value: '${s.totalJobsCompleted}', label: 'Completed', icon: Icons.check_circle_outline_rounded, color: _kGreen),
              ],
            ),
          ],
        ),
    ...
    return Expanded(
      child: Column(
        children: [
          ...
          Text(
            value,
            style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w700, color: _kText1, height: 1),
          ),
...
class _Card extends StatelessWidget {
  ...
  const _Card({required this.record, required this.ctrl});
